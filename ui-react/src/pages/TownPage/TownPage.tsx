...
import { useTown, useTownSection } from '../../hooks/useTown';
import { useGraphLoader, useGraphState } from '../../hooks/useGraph';
import MapComponent from '../../components/MapComponent';
import RoadsComponent from '../../components/RoadsComponent';
...
export const TownPage = () => {
    ...
    const handleGraphLoad = async (params: { name: string; regionId?: number; polygon?: any }) => {
        ...
        try {
            const data = await loadGraph({
                ...
                polygon: params.polygon, // Предполагается, что polygon будет в нужном формате
            });
            setGraphData(data);
            showRoads();
        } catch (error: any) {
    ...
    const handleDownload = () => {
        // Логика скачивания файлов будет добавлена позже
