...
## 📋 Содержание
- [Предварительные действия](#p1)
- [Запуск приложения](#p2)
- [Выключение сервера](#p4)
- [Тесты](#p5)
- [Анализ графов](#p6)
- [Граф придомовых проездов](#p7)
- [Экспорт CSV](#p8)
- [Утилиты в каталоге `tools`](#p9)

## <a id="p1">Предварительные действия</a>
...
На вход ноутбуки принимают JSON-файл, которые возвращают в качестве ответа методы `/api/city/graph/region/` и `/api/city/graph/bbox/`.
 ...
 ## <a id="p7">Граф придомовых проездов</a>
...
Файл можно использовать для дальнейшего анализа или сторонних визуализаций без необходимости ручного склеивания слоёв.
 ...
 ## <a id="p9">Утилиты в каталоге `tools`</a>
